...
- функционал игры на языке JS в файле «script.js».    
     ...
     Проект состоит из трех файлов:  «d.html»,  «style.css»,  «script.js»  и двух папок:  
одна – с изображениями игральных карт и иконки «Card», 
вторая – со стилями фреймворка «Bootstrap».

     Адаптивность веб-страницы реализована с помощью стилей фреймворка и функции clamp() в стилях файла «style.css». 
Функция clamp() обеспечила адаптивность кнопок и информационных экранов по вертикали.

     Для контроля корректности алгоритма наличие карт в колодах игроков выводится в консоль в виде массива (в этом виде они хранятся и обрабатываются в коде).
